...
<footer className="bg-white  shadow dark:bg-stone-900">
    <div className="w-full max-w-screen-xl mx-auto px-4 md:py-4">
        ...
        <span className="block pb-2 text-md text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" className="hover:underline">Kumar Gautam™</a>. All Rights Reserved.</span>
    </div>
</footer>
